...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\Auth\AuthenticateUserInterface' => \App\Actions\Auth\AuthenticateUser::class,
            'App\Contracts\Auth\LogoutActionInterface' => \App\Actions\Auth\LogoutAction::class,
            'App\Contracts\Auth\RegisterUserInterface' => \App\Actions\Auth\RegisterUserAction::class,
            'App\Contracts\Auth\ResendVerificationActionInterface' => \App\Actions\Auth\ResendVerificationAction::class,
            'App\Contracts\LawnCare\CreateLawnCareActionContract' => \App\Actions\LawnCare\CreateLawnCareAction::class,
            'App\Contracts\LawnCare\LogLawnCareActionContract' => \App\Actions\LawnCare\LogLawnCareAction::class,
            'App\Contracts\Lawn\DeleteLawnImageInterface' => \App\Actions\Lawn\DeleteLawnImage::class,
            'App\Contracts\Lawn\ImageArchiveInterface' => \App\Actions\Lawn\ArchiveLawnImage::class,
            'App\Contracts\Lawn\SaveLawnImageInterface' => \App\Actions\Lawn\SaveLawnImage::class,
    ...
    override(\config(), map([
            'Lawn.storage.base_path' => 'string',
            'Lawn.storage.temp.path' => 'string',
            'Lawn.storage.temp.retention_hours' => 'integer',
            'Lawn.storage.temp.cleanup_enabled' => 'boolean',
            'Lawn.storage.temp.disk' => 'string',
            'Lawn.storage.archive.enabled' => 'boolean',
            'Lawn.storage.archive.path' => 'string',
            'Lawn.storage.archive.retention_months' => 'integer',
            'Lawn.storage.archive.disk' => 'string',
            'Lawn.images.max_width' => 'integer',
            'Lawn.images.quality' => 'integer',
            'Lawn.images.allowed_types' => 'string',
            'Lawn.images.max_file_size' => 'integer',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'auth.verification.enable' => 'boolean',
            ...
            'filesystems.links./Users/chrisganzert/Herd/lawn-management/public/storage' => 'string',
            'livewire.class_namespace' => 'string',
            'livewire.view_path' => 'string',
            'livewire.layout.default' => 'string',
            ...
            'logging.channels.cleanup.driver' => 'string',
            'logging.channels.cleanup.path' => 'string',
            'logging.channels.cleanup.level' => 'string',
            'logging.channels.cleanup.days' => 'integer',
            'mail.default' => 'string',
            ...
            'navigation.breadcrumbs.models.lawn' => 'string',
            'navigation.breadcrumbs.segments.dashboard.dashboard.label' => 'string',
            'navigation.breadcrumbs.segments.dashboard.dashboard.route' => 'NULL',
            'navigation.breadcrumbs.segments.profile.index.profile.label' => 'string',
            'navigation.breadcrumbs.segments.profile.index.profile.route' => 'NULL',
            'navigation.breadcrumbs.segments.profile.edit.profile.label' => 'string',
            'navigation.breadcrumbs.segments.profile.edit.profile.route' => 'string',
            'navigation.breadcrumbs.segments.profile.edit.profile.edit.label' => 'string',
            'navigation.breadcrumbs.segments.profile.edit.profile.edit.route' => 'NULL',
            'navigation.breadcrumbs.segments.lawn.index.lawn.label' => 'string',
            'navigation.breadcrumbs.segments.lawn.index.lawn.route' => 'NULL',
            'navigation.breadcrumbs.segments.lawn.create.lawn.label' => 'string',
            'navigation.breadcrumbs.segments.lawn.create.lawn.route' => 'string',
            'navigation.breadcrumbs.segments.lawn.create.lawn.create.label' => 'string',
            'navigation.breadcrumbs.segments.lawn.create.lawn.create.route' => 'NULL',
            'navigation.breadcrumbs.segments.lawn.show.lawn.label' => 'string',
            'navigation.breadcrumbs.segments.lawn.show.lawn.route' => 'string',
            'navigation.breadcrumbs.segments.lawn.show.lawn.show.label' => 'string',
            'navigation.breadcrumbs.segments.lawn.show.lawn.show.route' => 'NULL',
            'navigation.breadcrumbs.segments.lawn.edit.lawn.label' => 'string',
            'navigation.breadcrumbs.segments.lawn.edit.lawn.route' => 'string',
            'navigation.breadcrumbs.segments.lawn.edit.lawn.edit.label' => 'string',
            'navigation.breadcrumbs.segments.lawn.edit.lawn.edit.route' => 'NULL',
...
'Lawn.storage.base_path','Lawn.storage.temp.path','Lawn.storage.temp.retention_hours','Lawn.storage.temp.cleanup_enabled','Lawn.storage.temp.disk',
'Lawn.storage.archive.enabled','Lawn.storage.archive.path','Lawn.storage.archive.retention_months','Lawn.storage.archive.disk','Lawn.images.max_width',
'Lawn.images.quality','Lawn.images.allowed_types','Lawn.images.max_file_size','app.name','app.env',
...
'auth.verification.enable','auth.verification.expire','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'filament.default_filesystem_disk','filament.assets_path','filament.cache_path','filament.livewire_loading_delay','filesystems.default',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/chrisganzert/Herd/lawn-management/public/storage','livewire.class_namespace',
'livewire.view_path','livewire.layout.default','livewire.lazy_placeholder','livewire.temporary_file_upload.disk','livewire.temporary_file_upload.rules',
...
'logging.channels.emergency.path','logging.channels.cleanup.driver','logging.channels.cleanup.path','logging.channels.cleanup.level','logging.channels.cleanup.days',
...
'mail.markdown.paths','navigation.breadcrumbs.models.lawn','navigation.breadcrumbs.segments.dashboard.dashboard.label','navigation.breadcrumbs.segments.dashboard.dashboard.route','navigation.breadcrumbs.segments.profile.index.profile.label',
'navigation.breadcrumbs.segments.profile.index.profile.route','navigation.breadcrumbs.segments.profile.edit.profile.label','navigation.breadcrumbs.segments.profile.edit.profile.route','navigation.breadcrumbs.segments.profile.edit.profile.edit.label','navigation.breadcrumbs.segments.profile.edit.profile.edit.route',
'navigation.breadcrumbs.segments.lawn.index.lawn.label','navigation.breadcrumbs.segments.lawn.index.lawn.route','navigation.breadcrumbs.segments.lawn.create.lawn.label','navigation.breadcrumbs.segments.lawn.create.lawn.route','navigation.breadcrumbs.segments.lawn.create.lawn.create.label',
'navigation.breadcrumbs.segments.lawn.create.lawn.create.route','navigation.breadcrumbs.segments.lawn.show.lawn.label','navigation.breadcrumbs.segments.lawn.show.lawn.route','navigation.breadcrumbs.segments.lawn.show.lawn.show.label','navigation.breadcrumbs.segments.lawn.show.lawn.show.route',
'navigation.breadcrumbs.segments.lawn.edit.lawn.label','navigation.breadcrumbs.segments.lawn.edit.lawn.route','navigation.breadcrumbs.segments.lawn.edit.lawn.edit.label','navigation.breadcrumbs.segments.lawn.edit.lawn.edit.route','queue.default',
...
'livewire.upload-file','livewire.preview-file','welcome','about',
'features','contact','privacy','terms','dashboard',
'profile.index','profile.edit','profile.update','profile.destroy','register',
'login','password.request','password.email','password.reset','password.store',
'verification.send','verification.notice','verification.verify','password.confirm',
'password.update','logout','lawn.index','lawn.create','lawn.show',
'lawn.edit','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.reset-password','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.input-error','components.input-label',
'components.layouts.authenticated.index','components.layouts.landing','components.layouts.landing.index','components.modal','components.navigation.footer.index',
'components.navigation.navbar.index','components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input',
'dashboard','landing.about','landing.contact','landing.features','landing.privacy',
'landing.terms','landing.welcome','layouts.aguest','layouts.app','livewire.auth.login',
'livewire.auth.register','livewire.auth.verification','livewire.components.delete-modal','livewire.components.lawn-image-upload','livewire.components.navigation.breadcrumbs',
'livewire.components.navigation.nav-menu-dropdown','livewire.components.navigation.user-menu-dropdown','livewire.lawn-care.create-fertilizing','livewire.lawn-care.create-mowing','livewire.lawn-care.create-watering',
'livewire.lawn.index-card','livewire.lawn.lawn-create','livewire.lawn.lawn-edit','livewire.lawn.lawn-index','livewire.lawn.lawn-show',
'livewire.lawn.overview-stats-card','profile.edit','profile.index','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action','filament-actions::button-group',
...
'filament-notifications::notification','filament-notifications::notifications','filament-tables::columns.checkbox-column','filament-tables::columns.color-column','filament-tables::columns.icon-column',
...
'filament-tables::index','filament::assets','filament::components.actions','filament::components.avatar','filament::components.badge',
...
'filament-actions::view-record.0','filament-actions::account-widget.0','filament-actions::filament-info-widget.0','filament-forms::components.builder.actions.clone.label','filament-forms::components.builder.actions.add.label',
...
'QUEUE_DRIVER','CACHE_DRIVER','CACHE_STORE','CACHE_PREFIX','MEMCACHED_HOST',
